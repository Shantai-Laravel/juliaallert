...
//     if ($(this).hasClass('thisfuckoff')) {
//        $(this).text('adaugă în wishlist');
//         $(this).removeClass('thisfuckoff');
//     }else {
//         $(this).addClass('thisfuckoff');
//         $(this).text('șterge din wishlist');
//     }
// });
$(document).ready(function(){
  var galop = $('.oneItem');
...
$(document).on('click', '.cart-alert', function(){
    ...
    // $el  = $(this).parents('.response-item').find('.selSize').find('checked');
    $(this).parents('.response-item').find('.lifeItemPop').each(function(key, value){
        // console.log(value);
        if ($(this).parents('.response-item').find('.lifeItemPop').eq(key).find("input[type=checkbox]:checked") == 1) {
            console.log($(this).parents('.response-item').find('.lifeItemPop').eq(key).find("input[type=checkbox]:checked"));
        }
    });
    ...
    //
    // }
    // $(this).parents('.response-item').find('.selSize').addClass('errorSelect');
