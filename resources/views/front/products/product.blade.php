                    ...
                    <div class="row">
                        <div class="col-12 descr">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-5 col-md-6 col-8 btn-cart-wish addToWishList {{ in_array($product->id, $wishListIds) ? 'thisfuckoff' : ''}}" data-product_id="{{$product->id}}">
                    ...
                    <div class="searchItem">
                        ...
                        <div class="response-subproduct">
                            ...
                            <div class="searchFt">
                                ...
                                <div>
                                    <div class="price">
                                        <span>{{ $productWearn->actual_price_lei }} euro</span>
                                        <span>{{ $productWearn->price_lei }} euro</span>
                                    </div>
                                </div>
                            </div>
                        </div>
