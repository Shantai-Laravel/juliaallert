<div class="header {{ $className }} widthDrop">
                    ...
                    <ul>
                        ...
                        <div class="modalOpen2">
                          ...
                          @if(Auth::guard('persons')->check())
                            ...
                            <div class="col-12 welcomeJa" style="margin-top: 20px;">{{trans('front.ja.wellcome')}} Julia Alert</div>
                            <div class="col-12">
                              <ul>
    ...
    <div class="menuRight menuNone menuRightMedium">
        <ul>
            ...
            <li class="lang header-lang-swich">{{ mb_strtoupper($lang->lang) }}</li>
              <div class="langOpen">
                 <ul>
