        ...
        <div class="row cartUserSet justify-content-center">
         <div class="col-5 nam">
           <div class="row">
             ...
             <div class="col-9 namSet">
               <div class="namSetButton" data-toggle="tooltip" data-placement="top" title="{{ trans('front.ja.popupcart') }}"><strong>{{ $cartSet->set()->first()->translation($lang->id)->first()->name }}</strong> ({{ trans('front.ja.oneset') }})</div>
               <div></div>
             </div>
           </div>
         </div>
         <div class="col-7">
           <div class="row detitemMobile">
             ...
             <div class="offset-2 col-md-3 col-8 text-center">
             ...
             <div class="col-12">
               <div class="row fwb">
                 ...
                 <div class="col-md-7 col-9">
                   <div class="row">
                     <div class="offset-8 col-md-3 text-right">
                         {{ $amountProds }} Lei
                     </div>
                   </div>
                 </div>
        ...
        <div class="row cartUserItem">
            ...
            <div class="col-md-7 col-12">
                <div class="row detitemMobile">
                    ...
                    <div class="offset-md-2 offset-0 col-md-3 offset-3 col-6 text-center">
                        @if ($stock > 0)
