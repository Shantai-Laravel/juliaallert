...
<div class="one oneSet">
  <div class="container-fluid">
    ...
    <div class="row response-item">
      ...
      <div class="offset-xl-1 col-xl-3 col-lg-4 col-md-4">
        <div class="row oneItemDet justify-content-center">

          @if ($amount > $set->price_lei)
              <div class="col-lg-11 col-md-12 col-sm-8 col-8 ungle pad">
                <div class="ungleBlack"></div>
                {{trans('front.ja.priceprods')}}<span>{{ $amount }} Lei</span>
              </div>
              <div class="col-lg-11 col-md-12 col-sm-8 col-8 pad">
                {{trans('front.ja.priceset')}} <span><strong>{{ $set->price_lei }}</strong> Lei</span>
              </div>
          @else
              <div class="col-lg-11 col-md-12 col-sm-8 col-8 ungle pad">
                <div class="ungleBlack"></div>
          ...
          <div class="col-lg-11 col-md-12 col-sm-8 col-8 searchImg justify-content-center">
