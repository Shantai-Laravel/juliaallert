...
<div class="col-lg-10 col-md-12">
    ...
    <div class="row justify-content-center">
        <div class="col-6 detMob">
            {{trans('front.ja.viewDetails')}}
        </div>
    </div>
            ...
            <div class="col-lg-6 col-md-3 col-sm-4 col-6 lifeDescr">
                ...
                @if (array_key_exists($product->id, @$filter[$set->id]))
                    @php
                        ...
                        $amount += $product->subproductById($subproductId)->first()->price_lei;
                    @endphp
                    <div>{{trans('front.ja.price')}}: <b>{{  $product->subproductById($subproductId)->first()->price_lei }} Lei</b></div>
                @else
                    <div>{{trans('front.ja.price')}}: <b>{{ $product->actual_price_lei }} Lei</b></div>
                    @php
                        $subproductId = 0;
                ...
                <div class="selSize">{{trans('front.ja.selectSize')}}</div>
