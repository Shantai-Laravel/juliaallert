...
{
    protected $fillable = ['category_id', 'set_id', 'promotion_id', 'alias', 'position', 'price', 'actual_price', 'price_lei', 'actual_price_lei', 'discount', 'hit', 'recomended', 'stock', 'code', 'video'];
