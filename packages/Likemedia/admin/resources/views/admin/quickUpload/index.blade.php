        ...
        <table class="table table-bordered centred ajax-response">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td rowspan="2">
                        <button type="button" name="button" class="btn btn-primary btn-sm subproducts-btn" data-toggle="modal" data-target="#subproducts-modal{{ $product->id }}"> <i class="fa fa-image"></i> Subproduse</button>
